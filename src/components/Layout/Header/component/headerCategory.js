...
const menu = (
  <Menu onClick={handleMenuClick}>
    <div className="MenuName">
      Basic Pages
      <Menu.Item key="about">
        <Link to="/about" className="menu_style">
          About
        </Link>
      </Menu.Item>
      <Menu.Item key="become-vendor">
        <Link to="/become-vendor" className="menu_style">
          Become Vendor
        </Link>
      </Menu.Item>
      <Menu.Item key="contact">
        <Link to="/contact" className="menu_style">
          Contact
        </Link>
      </Menu.Item>
      <Menu.Item key="register">
        <Link to="/register" className="menu_style">
          Register
        </Link>
      </Menu.Item>
      <Menu.Item key="faq">
        <Link to="/faq" className="menu_style">
          Faq
        </Link>
      </Menu.Item>
      <Menu.Item key="brands">
        <Link to="/brands" className="menu_style">
          Brands
        </Link>
      </Menu.Item>
      <Menu.Item key="terms">
        <Link to="/terms" className="menu_style">
          Terms and Conditions
        </Link>
      </Menu.Item>
      <Menu.Item key="help">
        <Link to="/help" className="menu_style">
          Help
        </Link>
      </Menu.Item>
      <Menu.Item key="coming">
        <Link to="/coming" className="menu_style">
          Coming Soon
        </Link>
      </Menu.Item>
      <Menu.Item key="404">
        <Link to="/NotFound" className="menu_style">
          404 Page
        </Link>
      </Menu.Item>
    </div>
    <div className="MenuName">
      ...
      <Menu.Item key="dashboard">
        <Link to="/dashboard" className="menu_style">
         Color Switch
        </Link>
      </Menu.Item>
      <Menu.Item key="products">
        <Link to="/products" className="menu_style">
         Image Switch
        </Link>
      </Menu.Item>
      <Menu.Item key="order">
        <Link to="/order" className="menu_style">
          External Product
        </Link>
      </Menu.Item>
      <Menu.Item key="customer">
        <Link to="/customer" className="menu_style">
          Grouped Product
        </Link>
      </Menu.Item>
      <Menu.Item key="settings">
        <Link to="/settings" className="menu_style">
          Bought Product
        </Link>
      </Menu.Item>
    </div>
    <div className="MenuName">
      ...
      <Menu.Item key="edit-account">
        <Link to="/profile" className="menu_style">
          Account Details
        </Link>
      </Menu.Item>
      <Menu.Item key="orders">
        <Link to="/profile/order" className="menu_style">
          Orders
        </Link>
      </Menu.Item>
      <Menu.Item key="address">
        <Link to="/profile/address" className="menu_style">
          Address
        </Link>
      </Menu.Item>
      <Menu.Item key="wishlist">
        <Link to="/rofile/favorites" className="menu_style">
          Wishlist
        </Link>
      </Menu.Item>
    </div>
    ...
    <div className="HeaderCategory  container">
      ...
      <div className="HeaderCategory_box">
        <div className="HeaderCategory_box_titles">
          ...
          <div className="HeaderCategory_box_titles_drop">
            <Button className="HeaderCategory_box_titles_drop">
              <div className="HeaderCategory_box_titles_drop_hover">
                {" "}
                Мужчины
              </div>
            </Button>
